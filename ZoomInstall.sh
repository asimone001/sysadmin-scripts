...
#
# NAME
#       ZoomInstall.sh -- Performs a clean install of Zoom. Can also be used to update to the latest version.
#
# SYNOPSIS
#       sudo ZoomInstall.sh
#
...
#       Version: 1.1
#
#       - Anthony Simone, 7.1.2021
#       (Adapted from the FirefoxInstall.sh script by Joe Farage, 18.03.2015)
#
####################################################################################################
# Script to download and install Zoom.
# Only tested on Intel systems. May or may not function on M1 Macs with some modification.
#

# Set preferences - set to anything besides "true" to disable. This version is pre-configured for SSO.
hdvideo="true"
ssodefault="true"
ssohost="COMPANYNAME.zoom.us"
